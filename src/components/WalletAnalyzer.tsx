...
export default function WalletAnalyzer() {
  ...
  const handlePasteSolAddress = async () => {
    try {
      ...
      console.warn("Clipboard access denied or not supported, autofilling a premium SOL address.", e);
    }
    // Fallback: paste/autofill a gorgeous realistic SOL address format
    const base58Alphabet = '123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz';
    let mockAddr = 'FXSVHzLvVFey57U8ETuhHzrzDRT3FhvqzbxW';
    for (let i = 0; i < 8; i++) {
