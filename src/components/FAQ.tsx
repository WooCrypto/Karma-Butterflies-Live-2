...
export default function FAQ({ isNested = false }: FAQProps) {
  ...
  const faqItems: FAQItem[] = [
    ...
    {
      id: 'faq-8',
      question: 'What is the PulsePay partnership and what is PulseScore?',
      answer: 'Karma AI is the core reputation intelligence engine powering PulseScore by PulsePay (https://pulsepayblockchain.live/pulse-score). PulsePay has partnered with us to integrate our multi-chain behavioral scoring framework to evaluate creditworthiness, user trustworthiness, and transaction health on the PulsePay Blockchain.'
    }
  ];
