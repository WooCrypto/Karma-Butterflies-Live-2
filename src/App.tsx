...
import PulsePayPartnership from './components/PulsePayPartnership';
...
export default function App() {
    ...
    if (typeof window !== 'undefined') {
      ...
      setTimeout(() => {
        ...
        if (card) {
          ...
          // Offset the scroll position to perfectly account for the announcement bar and navbar height
          const targetY = rect.top + scrollTop - (isBannerVisible ? 120 : 80);
          window.scrollTo({
  ...
  return (
    <div className={`min-h-screen bg-[#050505] text-white font-sans selection:bg-[#F59E0B]/30 selection:text-[#F59E0B] overflow-x-hidden ${isBannerVisible ? 'pt-10' : 'pt-0'}`}>
      ...
      {/* Strategic Partnership: PulsePay */}
      <PulsePayPartnership />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-start pb-16 border-b border-white/5">
            ...
            <div className="md:col-span-4 space-y-4">
              ...
              {/* Ecosystem Partnerships & Live Beta Statement */}
              <div className="bg-[#0B0B0D] border border-white/5 p-5 rounded-2xl space-y-3.5 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-24 h-24 bg-amber-500/5 rounded-full blur-2xl pointer-events-none" />
                <div className="flex items-center gap-1.5">
                  <span className="w-2 h-2 rounded-full bg-amber-500 animate-pulse" />
                  <h4 className="text-[10px] font-mono font-bold text-slate-200 uppercase tracking-[0.2em]">
                    Live Beta Testing
                  </h4>
                </div>
                <p className="text-slate-400 text-xs leading-relaxed font-sans">
                  Karma Butterflies is currently in live beta testing. We are dynamically validating on-chain credentials and scaling cross-chain deployment.
                </p>
                <div className="pt-2 border-t border-white/5 space-y-2">
                  <span className="text-[9px] font-mono text-[#F59E0B] uppercase tracking-[0.15em] block font-black">
                    Cross-Chain Testing Partner
                  </span>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 pt-1 font-mono text-[10px]">
                    <a 
                      href="https://pulsepay.online/" 
                      target="_blank" 
                      rel="noreferrer" 
                      className="flex items-center gap-1 text-amber-400 hover:text-amber-300 transition-colors bg-white/5 px-2.5 py-1.5 rounded-xl border border-white/5 hover:border-white/10"
                    >
                      <span>PulsePay Wallet</span>
                      <ExternalLink className="w-3 h-3" />
                    </a>
                    <a 
                      href="https://pulsepayblockchain.live/" 
                      target="_blank" 
                      rel="noreferrer" 
                      className="flex items-center gap-1 text-amber-400 hover:text-amber-300 transition-colors bg-white/5 px-2.5 py-1.5 rounded-xl border border-white/5 hover:border-white/10"
                    >
                      <span>PulsePay Explorer</span>
                      <ExternalLink className="w-3 h-3" />
                    </a>
                  </div>
                </div>
